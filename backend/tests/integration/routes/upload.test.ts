...
describe("Upload Routes", () => {
  // Create uploads directory before tests
  beforeAll(() => {
  ...
  describe("POST /api/auth/upload-image", () => {
    ...
    it("should reject non-image files", async () => {
      ...
      // ASSERT: Should reject with error (multer fileFilter rejects invalid types)
      // Multer's fileFilter returns 400 or 500 depending on error handling
